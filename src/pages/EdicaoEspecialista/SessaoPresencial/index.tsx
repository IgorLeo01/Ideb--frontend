...
import { SideBarContainer, SessionDataInfoContainer, TextContainer, ClinicInfoContainer, LocationInfoContainer,
    ...
    return (
        <MainContainer>            
            <BodyContainer>
                ...
                <DataContainer name="IPSI">
                    <DataHeader>
                        <h1>Sessão presencial</h1>
                        <h2>Valores de sessões particulares e corporativas no formato presencial.</h2>
                    </DataHeader>
                    <SessionDataInfoContainer>
                        <TextContainer>
                            <h2>Endereço de clínica de atendimento</h2>
                            <h3>Informe aos seus clientes o local para encontros presenciais.</h3>
                        </TextContainer>
                        <ClinicInfoContainer>
                            <input type="text" id="endereco"/>
                            <label htmlFor="endereco">Endereço da Clínica de atendimento</label>
...
export default DadosSessaoPresencial;
